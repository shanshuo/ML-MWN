...
class STTran(nn.Module):
    ...
    def __init__(self, mode='sgdet',
        ...
        self.a_rel_compress = nn.Linear(1936, self.attention_class_num)  # 3: looking at, not looking at, unsure
        self.s_rel_compress = nn.Linear(1936, self.spatial_class_num)  # 6: in front of, behind, on the side of, above, beneath, in
        self.c_rel_compress = nn.Linear(1936, self.contact_class_num)  # 17: carrying, drinking from, have it on the back, ...
